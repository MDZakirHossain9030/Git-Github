...
==>>computere একটা folder create করতে হবে অথবা
        github এ একটি repositiory(folder) create করতে হবে github এর repository বা folder যদি আমাদের computere আনতে চাই 
        তাহলে github থেকে url copy (enter) করে এনে  git bash গিয়ে লেখতে হবে =
                                                                                 git clone(url copy past)
